...
const productImages = [
  {
    src: '/press_tools.png',
    alt: 'Press Tools – Progressive Die Set',
  },
  {
    src: '/press_tools.png',
    alt: 'High-Tensile Press Tool Assembly',
  },
];

const features = ['Robust Build', 'Cost Effective', 'Easy To Use'];
        ...
        <div className="container-custom relative z-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={springFast}>
            <div className="flex items-center gap-2 text-slate-400 text-xs font-semibold uppercase tracking-widest mb-4">
              ...
              <span className="text-[#00A7FF]">Press Tools</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-tight">
              Press <span className="text-[#00A7FF]">Tools</span>
            </h1>
            <p className="text-slate-400 mt-3 text-sm font-medium max-w-xl">
              A wide range of high-quality Press Tools engineered by our expert team — widely used in varied industries for diverse applications.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            >
              ...
              <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
                <div className="p-8 md:p-10">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed font-medium mb-6">
                    We are highly instrumental in the process of manufacturing and supplying of a wide range of Press Tools. Engineered by our efficient team of experts press tools are widely used in varied Industries for diverse applications. Our tools are highly appreciated for their high-end features such as easy to use, long service life, high tensile strength and versatile applicability. We use high quality raw material to ensure that our tools are of fine quality.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                      ...
                      <span className="text-xs font-bold text-slate-700 uppercase tracking-wide">Long Service Life</span>
                    </div>
                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                      <div className="w-9 h-9 bg-[#FF5C00]/10 rounded-lg flex items-center justify-center shrink-0">
                        <Zap className="w-4 h-4 text-[#FF5C00]" />
                      </div>
                      <span className="text-xs font-bold text-slate-700 uppercase tracking-wide">High Tensile Strength</span>
                    </div>
                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                      ...
                      <span className="text-xs font-bold text-slate-700 uppercase tracking-wide">Versatile Use</span>
                    </div>
                  </div>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
                {sidebarCategories.filter(c => c.path !== '/products/press-tools').map((cat) => (
        ...
        {enquiryOpen && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setEnquiryOpen(false)}>
            <motion.div initial={{ scale: 0.9, y: 24, opacity: 0 }} animate={{ scale: 1, y: 0, opacity: 1 }} exit={{ scale: 0.9, y: 24, opacity: 0 }} transition={springFast} className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="text-slate-500 text-sm mb-6">Regarding: <span className="font-bold text-[#FF5C00]">Press Tools</span></p>
