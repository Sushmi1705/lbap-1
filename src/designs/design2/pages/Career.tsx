...
const Career = () => {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 font-['Outfit'] selection:bg-[#00A7FF]/20 selection:text-[#00A7FF] overflow-x-hidden min-h-screen">
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end">
              ...
              >
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  ...
                  <span className="text-sm font-mono text-slate-400">EXCELLENT</span>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center text-xs font-semibold">
                    <span className="text-slate-500">Mentee Output</span>
      ...
      <section id="culture" className="py-20 bg-white border-b border-slate-200/60">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-8">
            ...
            <div className="lg:col-span-7 bg-[#F4F7FA] border border-slate-200/60 p-12 lg:p-16 rounded-xl relative overflow-hidden flex flex-col justify-between shadow-sm animate-border-shimmer">
              ...
              <div className="space-y-6">
                ...
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed italic font-medium max-w-xl font-sans">
              ...
              <div className="flex items-center gap-5 mt-10 pt-6 border-t border-slate-200/60">
                ...
                <div className="w-16 h-16 rounded-xl overflow-hidden border-2 border-[#FF5C00] shadow-sm shadow-[#FF5C00]/25 shrink-0">
                  <img 
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-800 tracking-tight">RAHUL SHARMA</h4>
                  <p className="text-xs font-bold text-[#FF5C00] uppercase tracking-widest mt-1">LEAD TOOLING ENGINEER</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-[#000EDD] p-12 lg:p-16 rounded-xl flex flex-col justify-between text-white shadow-sm relative overflow-hidden">
              ...
              <div className="space-y-4">
                <span className="text-[#00A7FF] text-xs font-bold uppercase tracking-widest block">DEVELOPMENT CORE</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-8">
            ...
            <div className="lg:col-span-4 bg-white border border-slate-200/60 p-8 flex flex-col items-center text-center rounded-xl shadow-sm animate-border-shimmer relative">
              ...
              <h4 className="text-sm font-bold text-slate-800 tracking-tight mb-3">Collaborative Culture</h4>
            ...
            <div className="lg:col-span-8 bg-white border border-slate-200/60 p-8 flex flex-col md:flex-row items-center gap-10 rounded-xl shadow-sm animate-border-shimmer relative">
              ...
              <div className="flex flex-col items-center md:items-start shrink-0">
                ...
                <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Retention Rate</span>
              </div>
              <div className="hidden md:block w-px h-16 bg-slate-100"></div>
              <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-md font-sans font-medium">
      ...
      <section className="py-20 bg-slate-50 border-b border-slate-200/60">
        <div className="container-custom">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 tracking-tight">Technical Growth Pathway</h2>
          ...
          >
            {[
              ...
              >
                ...
                <div>
                  <span className={`text-xs font-mono font-bold tracking-widest block mb-10 ${item.active ? 'text-white/50' : 'text-[#00A7FF]'}`}>STEP_{item.step}</span>
            ...
            <div className="flex flex-wrap gap-1.5 bg-slate-50 border border-slate-200 p-1 rounded-md relative z-10 w-full md:w-auto">
              {([
                ...
                <button
                  ...
                  className="px-5 py-2 text-xs font-bold uppercase tracking-wider relative transition-all rounded z-10 flex-1 md:flex-initial"
                >
                  <span className={activeCategory === tab.id ? 'text-white font-extrabold transition-colors' : 'text-slate-500 hover:text-slate-850'}>
                    {tab.label}
                  </span>
              ...
              <AnimatePresence mode="popLayout">
                {filteredJobs.length > 0 ? (
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                        <div className="flex-grow space-y-4">
                          <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <span className="px-3.5 py-1.5 bg-[#00A7FF]/5 border border-[#00A7FF]/15 text-[#00A7FF] text-sm font-bold uppercase tracking-widest rounded-md">
                              {job.type}
                            </span>
                          </div>
                          <p className="text-slate-600 text-xs sm:text-sm font-sans font-medium max-w-2xl leading-relaxed">{job.desc}</p>
                  ...
                  >
                    ...
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest">No positions found</h4>
                    <p className="text-sm font-sans">Try widening your search query or choosing a different category filter.</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
